...
with tab1:
   ...
   df_region=df_region.drop(columns=["CODIGO_ENTIDAD","FECHA_INICIO_LICENCIAMIENTO","FECHA_FIN_LICENCIAMIENTO","PERIODO_LICENCIAMIENTO","UBIGEO","LATITUD","LONGITUD","FECHA_CORTE"])
