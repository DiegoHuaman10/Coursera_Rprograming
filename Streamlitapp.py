...
st.text("Mostrar al público qué instituciones del país son licenciadas por la Superintendencia Nacional de Educación Superior (SUNEDU) es importante, ya que permite conocer cuáles cumplen con las condiciones básicas de calidad como una buena infraestructura, además, garantiza la calidad académica y eficiencia de la formación de un futuro profesional como la proyección laboral en beneficio del estudiante.")
